(() => {
  ...
  const PRODUCT_GEOMETRY={
    ...
    new_49:{plate:{w:1312,h:1199,pw:957.0,cx:656.0,cy:935.2},price:{w:1990,h:2048,pw:1451.6,cx:995.0,cy:1331.2}},
    new_50:{plate:{w:1508,h:1043,pw:1100.0,cx:754.0,cy:813.5},price:{w:2048,h:1724,pw:1493.9,cx:1024.0,cy:1120.6}},
    new_51:{plate:{w:1312,h:1199,pw:957.0,cx:656.0,cy:935.2},price:{w:1993,h:2048,pw:1453.8,cx:996.5,cy:1331.2}},
    new_52:{plate:{w:1312,h:1199,pw:957.0,cx:656.0,cy:935.2},price:{w:1883,h:2048,pw:1373.5,cx:941.5,cy:1331.2}},
    new_53:{plate:{w:1508,h:1043,pw:1100.0,cx:754.0,cy:813.5},price:{w:2048,h:1720,pw:1493.9,cx:1024.0,cy:1118.0}},
    new_54:{plate:{w:1508,h:1043,pw:1100.0,cx:754.0,cy:813.5},price:{w:2048,h:1725,pw:1493.9,cx:1024.0,cy:1121.2}},
    new_55:{plate:{w:1508,h:1043,pw:1100.0,cx:754.0,cy:813.5},price:{w:2048,h:1720,pw:1493.9,cx:1024.0,cy:1118.0}},
    new_56:{plate:{w:1508,h:1043,pw:1100.0,cx:754.0,cy:813.5},price:{w:2048,h:1734,pw:1493.9,cx:1024.0,cy:1127.1}},
  };
  ...
  function setProduct(state,item,p){
    ...
    // new_48 (Arc Vase) uses a portrait canvas; on the shallow back lane it needs
    // a dedicated reduction so its visible plate matches the other back-lane plates.
    const laneScale=(state.name==='back' && p.id==='new_48') ? 0.91 : 1;
    const norm=(geo ? (TARGET_PLATE/geo.pw)*(geo.w/referenceCanvas) : 1)*laneScale;
    item.img.style.setProperty('--plate-normalize',norm.toFixed(4));
    // Arc Vase (48) and Wave Vase (49): move slightly toward the front on the back lane.
    item.img.style.bottom=(state.name==='back' && (p.id==='new_48' || p.id==='new_49')) ? '1%' : '';
