(() => {
  ...
  const PRODUCTS=[
    ...
    {id:'new_56',plate:'assets/new_56_plate.webp',price:'assets/new_56_price.webp'},
    {id:'new_57',plate:'assets/new_57_plate.webp',price:'assets/new_57_price.webp'},
    {id:'new_58',plate:'assets/new_58_plate.webp',price:'assets/new_58_price.webp'}
  ];
  ...
  const PRODUCT_GEOMETRY={
    ...
    new_48:{plate:{w:1199,h:1312,pw:874.6,cx:599.5,cy:1023.4},price:{w:1739,h:2048,pw:1268.5,cx:869.5,cy:1331.2}},
    new_49:{plate:{w:1199,h:1312,pw:874.6,cx:599.5,cy:1023.4},price:{w:1751,h:2048,pw:1277.3,cx:875.5,cy:1331.2}},
    new_50:{plate:{w:1312,h:1199,pw:957.0,cx:656.0,cy:935.2},price:{w:1990,h:2048,pw:1451.6,cx:995.0,cy:1331.2}},
    new_51:{plate:{w:1312,h:1199,pw:957.0,cx:656.0,cy:935.2},price:{w:1881,h:2048,pw:1372.1,cx:940.5,cy:1331.2}},
    new_52:{plate:{w:1508,h:1043,pw:1100.0,cx:754.0,cy:813.5},price:{w:2048,h:1724,pw:1493.9,cx:1024.0,cy:1120.6}},
    new_53:{plate:{w:1312,h:1199,pw:957.0,cx:656.0,cy:935.2},price:{w:1993,h:2048,pw:1453.8,cx:996.5,cy:1331.2}},
    new_54:{plate:{w:1312,h:1199,pw:957.0,cx:656.0,cy:935.2},price:{w:1883,h:2048,pw:1373.5,cx:941.5,cy:1331.2}},
    new_55:{plate:{w:1508,h:1043,pw:1100.0,cx:754.0,cy:813.5},price:{w:2048,h:1720,pw:1493.9,cx:1024.0,cy:1118.0}},
    new_56:{plate:{w:1508,h:1043,pw:1100.0,cx:754.0,cy:813.5},price:{w:2048,h:1725,pw:1493.9,cx:1024.0,cy:1121.2}},
    new_57:{plate:{w:1508,h:1043,pw:1100.0,cx:754.0,cy:813.5},price:{w:2048,h:1720,pw:1493.9,cx:1024.0,cy:1118.0}},
    new_58:{plate:{w:1508,h:1043,pw:1100.0,cx:754.0,cy:813.5},price:{w:2048,h:1734,pw:1493.9,cx:1024.0,cy:1127.1}},
  };
  ...
  function setProduct(state,item,p){
    ...
    const productScale=({new_51:0.78,new_54:0.78,new_58:0.78})[p.id] || 1;
    const norm=(geo ? (TARGET_PLATE/geo.pw)*(geo.w/referenceCanvas) : 1)*productScale;
  ...
  // Preload/decode cart images so the first click can render immediately.
  const cartImageCache=new Map();
  Promise.all(PRODUCTS.map(p=>{
    const img=new Image(); img.src=`assets/${p.id}_cart.webp`; cartImageCache.set(p.id,img);
